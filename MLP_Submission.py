...
MLP.fit(X_train, y_train, epochs=numEpoch, batch_size=numBatch,  validation_data=(X_test,y_test),verbose=1)
...
data_file = './MarchMadnessAdvStats.csv'
...
if save_model == 'y':
    ...
    with open("MLP_all.json", "w") as json_file:
        json_file.write(model_json)
        # serialize weights to HDF5
    MLP.save_weights("MLP_all.h5")
